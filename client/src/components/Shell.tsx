...
export function Shell({ children }: { children: ReactNode }) {
  ...
  // Pointing at a link is the earliest reliable signal of intent, so start the chunk
  // and the route's first request now rather than after the click.
  const warm = (to: string) => ({ onMouseEnter: () => prefetchRoute(to, queryClient), onFocus: () => prefetchRoute(to, queryClient) });
